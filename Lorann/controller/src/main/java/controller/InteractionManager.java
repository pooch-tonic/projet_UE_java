...
public class InteractionManager {
	 ...
	 */
	public InteractionEnum getInteractionOnNextPositionBetween(final IEntity entity, final IEntity target) {
	 ...
	 * @return the defined interaction between the entities.
	 */
	public InteractionEnum getInteractionOnCurrentPositionBetween(final IEntity entity, final IEntity target) {
		final InteractionEnum interaction;
