...
public abstract class QueryDAO extends AbstractDAO {
	 ...
	 *             the SQL exception
	 */
	public static String getUnitByPosition(final int x, final int y, final int mapId) throws SQLException {
	 ...
	 *             the SQL exception
	 */
	public static ArrayList<IVector> getUnitByType(final TypeEnum type, final int mapId) throws SQLException {
