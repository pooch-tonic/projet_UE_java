...
/**
 * <h1>The Entity class.</h1> An unit which is capable of moving, or performing
...
public abstract class Entity extends Unit implements IEntity {
	 ...
	 * @param scoreValue
	 */
	public Entity(final IVector position, final ISpriteSet spriteSet, final UnitTypeEnum type, final int durability,
	...
	private void configure() {
		...
		this.setDirection(VectorFactory.getLEFT());
